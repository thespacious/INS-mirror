services.factory('testService', function (APP_DEBUG) {
    ...
    //
    var fakeAssShit = function (result) {
        document.forms[0].fullname.value = "Jason Bissell"
        document.forms[0].license.value = "9650828";
        //return date in proper format
        document.forms[0].dob.value = "09-19-1986"
        document.forms[0].licensedate.value = "12-20-2016";
        document.forms[0].state.value = "AL";
        document.forms[0].street.value = "132 Amberbrook Loop";
        document.forms[0].city.value = "Salem";
        document.forms[0].zip.value = "36874";
    ...
    this.primaryDriverSubmit = function (driver, garagingInfo) {
        ...
        newDriver['gstreet'] = garagingInfo.gstreet.value;
        newDriver['gcity'] = garagingInfo.gcity.value;
        newDriver['gstate'] = garagingInfo.gstate.value;
        newDriver['gzip'] = garagingInfo.gzip.value;
